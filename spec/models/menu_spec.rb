...
describe Menu do
  it "processes a csv and populates the menu with the items from the file" do
    ...
    expect(menu.items(monday.strftime("%A"))).to match_array [
                                        ...
                                        Item.new("Alu Gobi", 5.95, "Yummy goodness", "food3.jpg", "monday,tuesday,wednesday,thursday,friday,saturday,sunday")
                                      ]
  end
