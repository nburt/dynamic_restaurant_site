...
describe FeaturedParagraph do
  it "should import the featured paragraph and populate the top paragraph with it" do
    paragraph = FeaturedParagraph.new(File.open("../dynamic_restaurant_site/config/featured_item.txt"))

    expect(paragraph.load).to eq "But be all this as it may; let the unseen, ambiguous synod in the air, or the vindictive princes and potentates of fire, have to do or not with earthly Ahab, yet, in this present matter of his leg, he took plain practical procedures; he called the carpenter.
